...
// const Cancellation = require('../models/Cancellation'); // ייבוא המודל שהוספנו
...
//       // אנחנו בודקים אם יש מסמך ביטול שמתאים ל-ID של החדר ולתאריך המבוקש
...
//       if (isCancelled) {
//         console.log(`Room ${room._id} is cancelled on this date. Skipping to next room...`);
//         continue; // החדר מבוטל, דלג לחדר הבא ברשימה
//       }
//       // ---------------------------------------------------------
